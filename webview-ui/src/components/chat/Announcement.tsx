	...
	return (
		<div
			...
			<p style={{ margin: "5px 0px" }}>
				To mark this new chapter, we're introducing the power to shape AIxCoding Agent into any role you need!
			...
			<p style={{ margin: "5px 0px" }}>
				We can't wait to see how you'll push AIxCoding Agent's potential even further! Share your custom modes
