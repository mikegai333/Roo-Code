...
export function languageForFilepath(fileUri: string, document: TextDocument): AutocompleteLanguageInfo {
	const extension = getUriFileExtension(fileUri)
	const defaultLanguage = {
		name: document.languageId,
		topLevelKeywords: [],
		endOfLine: [],
	}
	return LANGUAGES[extension] || defaultLanguage
}
