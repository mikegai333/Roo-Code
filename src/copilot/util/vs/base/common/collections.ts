...
export class SetWithKey<T> {
	...
	*values(): IterableIterator<T> {
	...
	forEach(callbackfn: (value: T, value2: T, set: any) => void, thisArg?: any): void {
		this._map.forEach(entry => callbackfn.call(thisArg, entry, entry, this as any));
	}
	...
	[Symbol.dispose](): void {
		// No-op, as there are no managed resources to dispose of in this Set implementation.
	}
