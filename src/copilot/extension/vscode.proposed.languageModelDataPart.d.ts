...
declare module "vscode" {
	...
	export class LanguageModelChatMessage2 {
		 ...
		 */
		static User(
			content: string | Array<LanguageModelTextPart | LanguageModelToolResultPart2 | LanguageModelDataPart>,
			name?: string,
		 ...
		 */
		content: Array<
			LanguageModelTextPart | LanguageModelToolResultPart2 | LanguageModelToolCallPart | LanguageModelDataPart
		>
	...
	export interface LanguageModelTool<T> {
		...
		invoke(
			...
			token: CancellationToken,
		): ProviderResult<LanguageModelToolResult2>
	}
	...
	export namespace lm {
		export function invokeTool(
			...
			token?: CancellationToken,
		): Thenable<LanguageModelToolResult2>
	}
}
