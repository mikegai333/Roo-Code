...
export class InformationDelta {
	...
	isUndoneBy(other: InformationDelta) {
		...
		if (
			...
			otherReallyDeletesMyInserts / otherReallyDeleted.size > N_GRAM_UNDO_RATIO_TO_FILTER_OUT
		) {
			return true
		}
		...
		if (
			...
			otherReallyInsertsMyDeletes / otherReallyNewInsertions.size > N_GRAM_UNDO_RATIO_TO_FILTER_OUT
		) {
			return true
		}
