...
export class EditReason {
	...
	private constructor(public readonly metadata: ITextModelEditReasonMetadata) {}
...
export const EditReasons = {
	...
	suggest: (data: { extensionId: string | undefined }) =>
		createEditReason({ source: "suggest", $extensionId: data.extensionId } as const),
}
