...
function deserializeSingleEdit(serialized: SerializedReplacement): StringReplacement {
	return new StringReplacement(new OffsetRange(serialized[0], serialized[1]), serialized[2])
}
 ...
 */
export function decomposeStringEdit<TEdit extends BaseStringEdit<BaseStringReplacement, TEdit>>(
	edit: TEdit,
