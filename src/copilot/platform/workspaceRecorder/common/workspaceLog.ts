...
export type DocumentSetContentLogEntry = DocumentLogEntry & {
	kind: "setContent"
	content: string
	/* if undefined, is 0 */ v: number | undefined
}

export type DocumentStoreContentLogEntry = DocumentLogEntry & {
	kind: "storeContent"
	contentId: string
	/* if undefined, is 0 */ v: number | undefined
}
...
export type DocumentRestoreContentLogEntry = DocumentLogEntry & {
	kind: "restoreContent"
	contentId: string
	/* if undefined, is 0 */ v: number | undefined
}
...
export type DocumentSelectionChangedLogEntry = DocumentLogEntry & {
