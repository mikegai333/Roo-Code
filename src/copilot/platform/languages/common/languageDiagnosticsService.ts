...
export const ILanguageDiagnosticsService =
	createServiceIdentifier<ILanguageDiagnosticsService>("ILanguageDiagnosticService")
...
export function getDiagnosticsAtSelection(
	...
	severities: DiagnosticSeverity[] = [DiagnosticSeverity.Error, DiagnosticSeverity.Warning],
