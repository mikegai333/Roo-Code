...
function asObjectSafe(value: any): object {
	...
	try {
		...
		console.warn("AIxCoding Agent <Language Model API>: Failed to parse object:", error)
		return {}
	}
}
...
export async function convertToAnthropicMessage(
	...
	if (anthropicRole !== "assistant") {
		throw new Error("AIxCoding Agent <Language Model API>: Only assistant messages are supported.")
	}
